...
import com.practicum.recyclerview_lesson_1.Comment
import com.practicum.recyclerview_lesson_1.CommentAdapter
...
class Activitytest1 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var user = mutableListOf<Comment>()
        ...
        recycler.adapter = CommentAdapter(
            comments = List(100) {
                Comment(
                    faker.name().fullName(),
                    faker.company().name(),
                    IMAGES[it % IMAGES.size],comments[Random.nextInt(0, 7)], Random.nextInt(0, 7)
                )
            }
        )
    }
